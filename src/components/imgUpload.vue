  ...
  <div class="uploadbox" v-if="add">
    ...
    <div class="upload" @click="uploadfn($event)">
      <div class="upload-icon">
        <img class="comment-phone" v-if="commentPhone" src="@/assets/images/photo.png">
           <img src="@/assets/images/storeplat/by_page2.png" v-else>
      </div>
  ...
  <div class="uploadbox" v-else>
    ...
    <div class="upload" @click="uploadfn($event)">
      <div class="upload-icon" v-if="!imgObj.url">
        <img src="@/assets/images/storeplat/by_page2.png">
      </div>
      <img class="comment-img" :src="imgObj.url" v-else>
      <input accept="image/*" type="file" style="display:none">
    </div>
    <div class="progress" v-if="zero">
      <div class="progress-text">{{ progressText }}</div>
...
<script>
export default {
  props: ["img",'add','stop','text','delete','commentPhone'],
  data () {
    return {
      imgObj:{},
      progress:0,
