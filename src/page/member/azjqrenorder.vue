    ...
    <div class="buy-card-record">
        ...
        <div class="mian">
            ...
            <div class="pay-box">
                ...
                <!-- <div class="between-flex" v-if="$store.state.weixin2">
    ...
    export default {
        ...
        data() {
            return {
                ...
                post: {},
                xuka: '',
                orderOrigin: this.$route.query.systemCode,
                weixinshow: false
            };
        },
        created() {
        ...
        methods: {
            getUpgradePrice() {
                axios({
                    url: this.Api + 'goods/getUpgradePrice?userId=' + this.userid + '&cardType=' + this
                        .cardType + '&levelId=' + this.level + '&seq=' + this.seq,
                    method: "get",
                    headers: {
            ...
            goback() {
                ...
                window.location.href = this.Alinks + '/localQuickPurchase/activity/baiye.html'
            ...
            priceCheck() {
                ...
                if (this.areadata['prov'].name == undefined) {
                    this.areadata['prov'].name = ''
                    Toast({
                        message: "请选择省",
                        position: "middle"
                    });
                ...
                if (this.areadata['city'].name == undefined) {
                    this.areadata['city'].name = ''
                    Toast({
                        message: "请选择省",
                        position: "middle"
                    });
                ...
                if (this.areadata['area'].name == undefined) {
                    this.areadata['area'].name = ''
                    Toast({
                        message: "请选择省",
                        position: "middle"
                    });
                ...
                axios({
                    method: "post",
                    url: this.Api + "agency/updateAreaFromLovingHome",
                    headers: {
                        "X-Nideshop-Token": this.$cookie.get('token')
                    },
                    data: params
                    ...
                    if (res.data.code == 0) {
                        ...
                        axios({
                            url: this.Api + '/order/submit?userId=' + this.userid + '&cardType=' +
                                this.cardType + '&payMethod=' + this.way + '&orderOrigin=' + this
                                .orderOrigin,
                            method: "post",
                            headers: {
                                "X-Nideshop-Token": this.$cookie.get('token')
