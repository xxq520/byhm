<template>
  <div class="order">
    ...
    <div class="wancheng-box">
        ...
        <!-- 上传汇款单 -->
        <div class="reason-box" v-if="orderDeails.imgUrlArr && orderDeails.imgUrlArr.length > 0">
    ...
    <template v-if="orderDeails.order_status  == 501|| orderDeails.order_status == 502">
        <div class="upload-btn" @click="upLoadImg">取消订单</div>
    </template>
    
    <template v-if="orderDeails.order_status  == 0">
        <div class="fix-box" >
