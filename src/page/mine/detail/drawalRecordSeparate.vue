                    ...
                    <div class="mint-cell-wrapper">
                      <div class="mint-cell-title">
                        <div class="mint-cell-text">
                          <div class="mr-r-5">
                            <!--{{ post.bankName + '(' + post.bankCardNo.substr(0,4) + '*******' + post.bankCardNo.substr(-4) + ')' }}-->
...
export default {
  ...
  created() {
    ...
    if(this.index==3){
       let type = 0;
    axios.get(this.Api + 'withdraw/infoLedgerByMonth?userId=' +this.userId,
    {
       headers: {
   ...
   if(this.index==5){
       let type = 1;
        axios.get(this.Api + 'withdraw/infoGhtLedgerByMonth?userId=' +this.userId,
        {
        headers: {
        "X-Nideshop-Token": this.$cookie.get('token')
        }
  ...
  methods: {
    ...
    loadMore(post,n){
      ...
      that.more(n,'load');
      // axios.get(this.Api+'/withdraw/listLedger',{params:post},).then(res => {
    ...
    listClick(obj){
      this.$router.push({path:'/banking/withdrawalProcess2?id='+obj.id})
    },
    amountfn(val){
