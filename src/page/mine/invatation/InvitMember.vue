<template>
   <div class="InvitMember" >
     <header class="mint-header" id="headerInvait">
        ...
        <h1 class="mint-header-title">邀请成为超级会员用户</h1>
    </header>
    <!-- 底部海报轮播 -->
...
export default {
   ...
   mounted(){
     ...
     this.$nextTick (function () {
        ...
        // this.uri = host+'/#/toBecomeMember/' + this.$cookie.get('card') +'/1/1'
        //swiper轮播
   ...
   methods: {
    ...
    showShare(){
      var that = this
        console.log(that.uri,'76')
      var ua = navigator.userAgent.toLowerCase();
      if (ua.match(/MicroMessenger/i)=="micromessenger") {
        console.log(that.uri,'73')
         wxshare(that.uri);
