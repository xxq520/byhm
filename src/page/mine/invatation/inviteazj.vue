<template>
    <div class="InvitChoice">
        <header class="mint-header" id="headerInvait">
            ...
            <h1 class="mint-header-title">分享爱之家商城</h1>
        </header>
        <!-- 底部海报轮播 -->
        <div class="swiper-container">
            <!-- <div class="swiper-wrapper">
                <div class="swiper-slide"> -->
                    <div class="proxy">
                        <img src="@/assets/images/azjsc.jpg" class="proxy_bg">
    ...
    export default {
        ...
        data() {
            return {
                ...
                uri: 'http://nfxts.520shq.com/localQuickPurchase/distributionVA/index?shareSeq='+this.$cookie.get('seq'),
                imgUrl: '',
        ...
        mounted() {
            ...
            this.$nextTick(function () {
                ...
                this.uri = "http://nfxts.520shq.com/localQuickPurchase/distributionVA/index?shareSeq="+this.seq
                //swiper轮播
            ...
            showShare() {
                ...
                if (ua.match(/MicroMessenger/i) == "micromessenger") {
                    ...
                    if (sessionStorage.getItem('applogin') || this.$route.query.platform == 'android' || this.$route
                        .query.platform == 'ios') {
                        window.action.SharePosters(title, desc, dataURL);
                    } else {
                        Toast('请保存页面二维码进行邀请');
                    }
