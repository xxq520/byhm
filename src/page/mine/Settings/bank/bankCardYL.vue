      ...
      <div class="cart-item">
        ...
        <div class="cart-box">
          <div class="cart-list">
            <label>开户账户姓名：</label>
            <p class="lmain">
              <input type="text" placeholder="请输入开户账户姓名"  v-model.trim="userName">
            </p>
          </div>
          <div class="cart-list">
            <label>开户行：</label>
          ...
          <div class="cart-list">
            <label>开户账户：</label>
            <p class="lmain">
              <input type="text" placeholder="请输入开户账户" v-model="account" :attr="{ maxlength: 19 }">
            </p>
          </div>
          <div class="cart-list">
            <label>身份证号码：</label>
...
export default {
  ...
  mounted(){
    this.shopName = this.userName+'个体工商'
  },
  methods: {
    // 开户地址
     bankAdressfn(){
    ...
    // 获取支行数据
    getBranchBankList(){
      console.log(this.bankAdress.area.id);
      console.log(this.bankAdress.city.id)
      let param = {
        key: this.bank,
        cityId:this.bankAdress.area.id
      }
      axios({
        method: "post",
